        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HitTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsShipHit = table.Column<bool>(type: "boolean", nullable: false),
                    HitShipId = table.Column<Guid>(type: "uuid", nullable: true),
                    Created = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Modified = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardHits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BoardHits_Boards_BoardId",
                        column: x => x.BoardId,
                        principalTable: "Boards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoardHits_Ships_HitShipId",
                        column: x => x.HitShipId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardHits_BoardId",
                table: "BoardHits",
                column: "BoardId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardHits_HitShipId",
                table: "BoardHits",
                column: "HitShipId");
